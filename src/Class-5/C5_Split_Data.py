...
# Example usage
file_path = 'data/class_5_data/C5_80_20_clean.csv'  # Input file path
output_train_file = 'data/class_5_data/C5_80_train_data.csv'
output_test_file = 'data/class_5_data/C5_20_test_data.csv'
