...
# CONFIGURATION
# ==============================================================================
TRAIN_DATA_PATH = 'data/class_5_data/C5_train_data.csv'
MODEL_BUNDLE_PATH = 'data/output/C5_model_bundle.joblib'
...
def plot_training_history(history):
    ...
    plt.savefig('data/output/C5_training_history.png')
    plt.show()
